...
import { useOrdersDetailsQuery,   useDeleteOrderMutation,
 
  useUpdateOrderMutation, } from "../../../redux/api/orderAPI";
...
const TransactionManagement = () => {
  ...
  const {user} =useSelector((state:{useReducer:UserReducerInitialState})=>state.userReducer);
